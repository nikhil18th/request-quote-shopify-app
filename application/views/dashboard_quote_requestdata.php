...
<script>
var shopUrl = 'https://appinstallteststore.myshopify.com/';
...
var app = createApp({
apiKey: '<? echo API_KEY ?>',
host: 'https://bigcapp-test-demo.demolocations.com/',
forceRedirect: true,
});
...
console.log("keepRetrievingToken",keepRetrievingToken(app));
console.log("retrieveToken",retrieveToken(app));
...
header(
      ...
      `frame-ancestors https:appinstallteststore.myshopify.com/ https://admin.shopify.com;`
    );
?>
...
<div class="dashboard">
   <?php //$this->load->view('welcome_dashboard');
//print_r($data);
?> 
</div>
<br>

<!-- <button class="toggle gray">dashboard</button> -->
<br>

<div class="request-to-quote orange">
    <p class="title">Submission List</p>
 ...
 <tbody>
                  ...
                  ?>
                    <tr class="">
                        ...
                        <td class=""><?= $redord['enquiry_for'];?></td>
                        <td class=""><?= $redord['message'];?></td>
                        <td class=""><button type="button" 
                      data-id="<?=$redord['id']?>" data-date="<?=$redord['created_at']?>" data="" data-name="<?= $redord['name'];?>" data-email="<?= $redord['email'];?>" data-phone="<?= $redord['phone'];?>" data-enq="<?= $redord['enquiry_for'];?>" data-msg="<?= $redord['message'];?>" class="btn btn-info modal-toggle" onclick="toggleModal()">View</button>
                  </td>
...
<style type="text/css">
 ...
 <div class="fixed z-10 overflow-y-auto top-0 w-full left-0 hidden" id="modal">
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                         <a id="wishlist_data" class="btn btn-primary"  href="<?php echo  base_url(); ?>/homepage/dashboradViewLoad"><i class="fa fa-sliders" aria-hidden="true"></i>Back</a>

                        <h1 class="modalh1" style="text-align: center;font-size: 23px;">
                        Request Quote Details</h1>
                        ...
                        <p><label>Inquery For : </label> <span class="data_inq"><span> </p>
...
function toggleModal() { 
    document.getElementById('modal').classList.toggle('hidden')
        ...
        $("#example tbody").on("click",".modal-toggle",function(){
          ...
          var data_inq = $(this).attr('data-enq');
